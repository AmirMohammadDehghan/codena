...
class CustomUserManager(BaseUserManager):
    ...
    def create_user(self, phone_number, password=None, username=None, email=None, **extra_fields):
        extra_fields.setdefault('is_staff', False)
        extra_fields.setdefault('is_superuser', False)
        return self._create_user(username, email,phone_number, password, **extra_fields)

    def create_superuser(self, phone_number, password=None, username=None, email=None, **extra_fields):
