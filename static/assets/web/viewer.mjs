...
let urlGetFromInput = urlInput.getAttribute('data-url')
{
  defaultOptions.defaultUrl = {
    value: urlGetFromInput,
    changeDocumentTitle: (function () { urlInput.remove(), urlInput = '', urlGetFromInput = '' })(),
    kind: OptionKind.VIEWER
  };
...
const LAYERS_ORDER = new Map([["canvasWrapper", 0], ["textLayer", 1], ["xfaLayer", 3]]);
class PDFPageView {
    ...
    Promise.all([firstPagePromise, permissionsPromise]).then(([firstPdfPage, permissions]) => {
      ...
      if (annotationEditorMode !== AnnotationEditorType.DISABLE) {
        ...
        if (pdfDocument.isPureXfa) {
          ...
          this.#annotationEditorUIManager = new AnnotationEditorUIManager(this.container, viewer, this.#altTextManager, eventBus, pdfDocument, pageColors, this.#enableHighlightFloatingButton, this.#mlManager);
