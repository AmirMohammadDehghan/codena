...
pdfjs-scroll-page-button = پیمایش صفحه
pdfjs-spread-none-button-label = نمایش تک صفحه ای
pdfjs-spread-odd-button-label = نمایش دو صفحه ای
pdfjs-find-match-count-limit =
    { $limit ->
        [one] بیش از { $limit } مورد یافت شد
       *[other] بیش از { $limit } مورد یافت شد
    }
pdfjs-layers-button =
    .title = نمایش لایه ها (برای بازنشانی همه لایه ها به حالت پیش فرض، دوبار کلیک کنید)
