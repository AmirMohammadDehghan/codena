...
function themeDarker() {
    ...
    if (wordFromCodnaImage) {
        wordFromCodnaImage.src = 'static/assets/img/bg-semicircular.png'
    }
...
function themeLighter() {
    ...
    if (logo) {
        logo.forEach(el => {
            el.src = 'static/assets/img/logo-light.png'
        })
    }
    if (wordFromCodnaImage) {
        wordFromCodnaImage.src = 'static/assets/img/bg-semicircular-light.png'
    }
    if (textLight) {
        textLight.forEach(el => {
